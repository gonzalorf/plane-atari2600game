...
;Variables RAM (128 bytes)

    	SEG.U vars
    	org $0080
    	
;variables del background
moveBkGround		ds 1	;altura de las olas (franjas background)
bkMask			ds 1		;color modo autoplay

;plane variables
planePtr		ds 2	;puntero al gráfico del aeroplano
planeColorPtr		ds 2	;puntero al color del aeroplano
planeSpeed		ds 1		;velocidad del aeroplano
planeMovem		ds 1		;???

;punteros al objeto 1, 2 y 3
obj1Ptr			ds 2		
obj2Ptr			ds 2		
obj3Ptr			ds 2		
objColor1Ptr		ds 2
...
;info sobre los objetos
object1			ds 1	;respetar el orden (!)
verPosObj1		ds 1
object2			ds 1
verPosObj2		ds 1
object3			ds 1
verPosObj3		ds 1
;22
;posiciones verticales de todos los objetos
verPosM0		ds 1		
verPosM0a		ds 1		
verPosM0b		ds 1		
verPosPF		ds 1
...
;posiciones horizontales de todos los objetos
horPosPlane		ds 1		
horPosObj1		ds 1	;rango 0-156 max. por objeto
horPosObj2		ds 1		
horPosObj3		ds 1
horPosM0		ds 1
horPosM0a		ds 1
...
rand			ds 2	;número random
pFShape			ds 1	;forma de la isla
fCounter		ds 1	;framecounter
currCTRLPF		ds 1	;???
;43

score1			ds 1	;valores de puntos
score2			ds 1

level1Ptr		ds 2	;valores de nivel
level2Ptr		ds 2
livesPtr		ds 2

score1RAM		ds 5	;gráficos de score en RAM (6 digit trick)
score2RAM		ds 5
score1Ptr		ds 2
score2Ptr		ds 2

;67
;variables de puntos, nivel y vidas
scoreTmp		ds 1
livesLevel		ds 1	;Bits 7,6,5 = vidas. Resto = nivel
time			ds 1
fraTime			ds 1
km			ds 1
fraKm			ds 1
intKm			ds 1
;variables para el playfield asimétrico (barra de velocidad)
pFI			ds 1	;izquierda
pFD			ds 1	;derecha

;variables solo de uso durante el kernel
branch			ds 1
currObj			ds 1
currObjPtr		ds 2
currObjColorPtr		ds 2

;variables solo de uso durante overscan/vertblank
flyLow			ds 1
intSpeed		ds 1
fraSpeed		ds 1
;86
